...
🪄 ขี้เกียจสุด/รีบสุด: เปิด `00_AUTO_SOLVER.ipynb` แก้แค่ชื่อ competition (หรืออัปโหลด zip) แล้วกดรัน
มันเดาประเภทงานเอง + เทรน + สร้าง submission ให้อัตโนมัติ (รูป/ข้อความ/ตาราง/ทำนายตัวเลข)
...
- `ADVANCED_SOTA.md` — SOTA อัปเดต (รีเฟรชกลางปี 2026) + วิธีดันคะแนน (id ตรวจกับ HF/PyPI แล้ว)
- `LIBRARIES.md` — library เจ๋ง ๆ ที่ทำให้ชีวิตง่ายขึ้นต่อหัวข้อ (cleanlab/setfit/aeon/unsloth/CLAP ฯลฯ)
- `PLAYBOOK.md` — ลำดับทำงานในห้องสอบ | `TROUBLESHOOTING.md` — error -> วิธีแก้
