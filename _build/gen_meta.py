...
ขี้เกียจ/รีบ? เปิด `00_AUTO_SOLVER.ipynb` แก้แค่ชื่อ competition แล้วกดรัน มันเดา+เทรน+สร้าง submission ให้เอง (รูป/ข้อความ/ตาราง)
...
| ไฟล์เสียง -> 1 คลาส (จำแนกเสียง) | `06_Audio/audio_classification.ipynb` |

ทุกโน้ตบุ๊กมี `วิธีที่ 1 (ง่ายสุด)` อยู่บนสุด มือใหม่ทำแค่วิธีที่ 1 ก็ได้คะแนนแล้ว

ขี้เกียจ/รีบ -> `00_AUTO_SOLVER.ipynb` (รูป/ข้อความ/ตาราง ทำให้อัตโนมัติ)
อ่านลำดับทำงานทีละขั้น -> `PLAYBOOK.md` | เจอ error -> `TROUBLESHOOTING.md` | โจทย์แปลก -> `PROBLEM_TYPES.md`
"""))
