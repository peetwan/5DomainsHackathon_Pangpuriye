...
ไม่รู้ว่าโจทย์ต้องส่งอะไร/วัดด้วยอะไร: ทุกโน้ตบุ๊กมีเซลล์ `🔎 โจทย์นี้ต้องส่งอะไร` (ดึง metric จาก Kaggle + บอกชนิดคอลัมน์ให้)
เจอโจทย์แปลก/ยาก: ดู `PROBLEM_TYPES.md` (แผนที่ "เจอแบบนี้ ทำแบบนี้" ครบทุกแบบ)
